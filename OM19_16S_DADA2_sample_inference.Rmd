...
path <- "/Users/melo.d/Desktop/Research/Oman_fieldwork/2019/Dan_Nothaft_16S_Data/demux-seqs" # CHANGE ME to the directory containing the fastq files after unzipping.
list.files(path)
```
...
```{r save-seqtab}
write_rds(seqtab.nochim, path = "data_output/seqtab.nochim.rds", compress = "gz")
```
