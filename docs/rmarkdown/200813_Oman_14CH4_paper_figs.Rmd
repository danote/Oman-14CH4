...
data_literature <-  read_csv("data_raw/Summary_metadata/CH4_isotope_literature_data.csv", na = "NA")
...
data_ASF_NSHQ14_mol_frac_longer <- data_ASF_NSHQ14_mol_frac_longer %>% mutate(site = "NSHQ14") %>% select(C_number, log10_mol_frac, site)
