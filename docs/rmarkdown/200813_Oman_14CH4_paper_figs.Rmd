...
## Plot
### Plot data
```{r alkanes-d13C-oman-wells-and-lit-plot, fig.height=6, fig.width=3.42, warning=FALSE}
# create plot
...
# create plot
alkanes_d13C_oman_wells_and_lit_plot_for_col_leg <- ggplot() +
...
leg_color <- get_legend(alkanes_d13C_oman_wells_and_lit_plot_for_col_leg)
...
## Plot
```{r, "plot-CH4_F14C-d13C-dD-lab-color", fig.width = 3.42, fig.height = 3.5}
...
```{r, "plot-CH4_F14C-d13C-dD-year-color-shape", fig.width = 3.42, fig.height = 4.5}
...
```{r, "plot-CH4_F14C-d13C-dD-year-color-shape-clean", fig.width = 3.42, fig.height = 4.5}
...
```{r, "plot-CH4_F14C-d13C-dD-year-color-shape-clean-letter-tagged", fig.width = 3.42, fig.height = 4.5}
